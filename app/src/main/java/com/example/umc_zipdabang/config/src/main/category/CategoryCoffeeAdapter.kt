...
class CategoryCoffeeAdapter(private val context: CategoryCoffeeActivity, private val dataList: ArrayList<My_Scrap>) :
    RecyclerView.Adapter<CategoryCoffeeAdapter.ViewHolder>(){
