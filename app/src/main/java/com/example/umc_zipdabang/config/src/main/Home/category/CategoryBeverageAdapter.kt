...
class CategoryBeverageAdapter(private val context: CategoryBeverageActivity, private val dataList: ArrayList<My_Scrap>) :
    RecyclerView.Adapter<CategoryBeverageAdapter.ViewHolder>(){
