...
class WellbeingOurLoadingRVAdapter(private val context: OurRecipeWellbeingActivity, private var dataList: ArrayList<WellbeingRecipesData>, private var idList: ArrayList<Int?>) :
