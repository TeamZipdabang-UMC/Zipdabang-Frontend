...
class CategoryHealthAdapter(private val context: CategoryHealthActivity, private val dataList: ArrayList<My_Scrap>) :
    RecyclerView.Adapter<CategoryHealthAdapter.ViewHolder>(){
