...
class SmoothieOurLoadingRVAdapter(private val context: OurRecipeSmoothieActivity, private var dataList: ArrayList<SmoothieRecipesData>, private var idList: ArrayList<Int?>) :
