            ...
            GlobalScope.launch(Dispatchers.IO) {
                ...
                service.get_Main(token1).enqueue(object :
                    ...
                    override fun onResponse(
                        ...
                        adapter2.setOnItemClickListener1(object :
                            ReceipeAdapter.OnItemClickListener {
                        ...
                        adapter2.setOnItemClickListener2(object :
                            ReceipeAdapter.OnItemClickListener {
                        ...
                        adapter2.setOnItemClickListener(object :
                            ...
                            override fun onItemClick(v: View?, pos: Int, category: String) {
                                ...
                                when (pos) {
                                    ...
                                    0 -> {
                                        val intent =
                                            Intent(context, CategoryCoffeeActivity::class.java)
                                        startActivity(intent)
                                    }
                                    1 -> {
                                        val intent =
                                    ...
                                    2 -> {
                                        val intent =
                                            Intent(context, CategoryTeaActivity::class.java)
                                        startActivity(intent)
                                    }
                                    3 -> {
                                        val intent =
                                            Intent(context, CategoryAdeActivity::class.java)
                                        startActivity(intent)
                                    }
                                    4 -> {
                                        val intent =
                                    ...
                                    5 -> {
                                        val intent =
                                            Intent(context, CategoryHealthActivity::class.java)
                                        startActivity(intent)
                                    }
