...
class CategoryTeaAdapter(private val context: CategoryTeaActivity, private val dataList: ArrayList<My_Scrap>) :
    RecyclerView.Adapter<CategoryTeaAdapter.ViewHolder>(){
