...
import com.example.umc_zipdabang.src.main.zipdabang_recipe_rv_adapter.CoffeeRecipesRVAdapter
...
class ZipdabangRecipeCoffeeActivity: AppCompatActivity() {
    ...
    private lateinit var coffeeRecipesRVAdapter: CoffeeRecipesRVAdapter
...
//        viewBinding.rvZipdabangRecipeBeverage.layoutManager = GridLayoutManager(this, 2)
    ...
    private fun initAdapter() {
        coffeeRecipesRVAdapter = CoffeeRecipesRVAdapter(this, coffeeRecipesList)
