...
class FirstQuestionActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        service.get_quest_list(token).enqueue(object :
            ...
            override fun onResponse(
                ...
                while (true) {
                    ...
                    if (questlist.size == result?.data?.size) {
                        break
                    }
                    i++
                    Log.d("끝", i.toString())
                ...
                adapter.setOnItemClickListener(object : QuestionAdapter.OnItemClickListener {
                    override fun onItemClick(v: View?, pos: Int) {
                        ...
                        service.getQuestionInfo(questlist[pos].id, token).enqueue(object :
                            ...
                            override fun onResponse(
                                ...
                                val intent =
                                    Intent(applicationContext, QuestionLookupActivity::class.java)
