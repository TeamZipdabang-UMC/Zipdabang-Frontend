...
import com.example.umc_zipdabang.src.main.zipdabang_recipe_comment.ZipdabangRecipeDetailCommentSmoothieActivity
...
class ZipdabangRecipeDetailSmoothieActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.tvZipdabangRecipeCommentViewDetail.setOnClickListener {
            val intent = Intent(this, ZipdabangRecipeDetailCommentSmoothieActivity::class.java)
        ...
        viewBinding.btnChallengeComplete.setOnClickListener {
            ...
            commentButton.setOnClickListener {
                ...
                val commentIntent = Intent(this, ZipdabangRecipeDetailCommentSmoothieActivity::class.java)
