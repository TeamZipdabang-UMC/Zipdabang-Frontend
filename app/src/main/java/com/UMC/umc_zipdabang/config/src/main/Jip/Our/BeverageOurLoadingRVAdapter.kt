...
class BeverageOurLoadingRVAdapter(private val context: OurRecipeBeverageActivity, private var dataList: ArrayList<BeverageRecipesData>, private var idList: ArrayList<Int?>) :
