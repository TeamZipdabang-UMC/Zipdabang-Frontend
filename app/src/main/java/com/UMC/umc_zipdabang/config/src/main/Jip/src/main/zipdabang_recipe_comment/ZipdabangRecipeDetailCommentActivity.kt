...
import com.UMC.umc_zipdabang.databinding.ActivityZipdabangRecipeDetailCommentBinding
...
class ZipdabangRecipeDetailCommentActivity : AppCompatActivity() {
    ...
    private var commentNumberList =
        ArrayList<com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.Comment>()
    private var page = 1
...
//        }
    ...
    class CommentInfiniteRVAdapter(
        ...
        public var commentNumberList: ArrayList<com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.Comment>,
        val recipeId: String?
        ...
        class CommentInfiniteViewHolder(private var binding: ItemCommentBinding) :
            ...
            fun bind(
                context: Context,
                item: com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.Comment,
