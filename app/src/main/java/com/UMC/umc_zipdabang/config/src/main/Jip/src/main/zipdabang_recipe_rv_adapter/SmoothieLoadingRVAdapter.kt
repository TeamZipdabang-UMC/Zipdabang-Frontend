...
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_activities_fragments.ZipdabangRecipeSmoothieActivity
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.ZipdabangRecipeDetailActivity
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_data_class.SmoothieRecipesData
...
class SmoothieLoadingRVAdapter(private val context: ZipdabangRecipeSmoothieActivity, private var dataList: ArrayList<SmoothieRecipesData>, private var idList: ArrayList<Int?>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    fun update(list : ArrayList<SmoothieRecipesData>){
        this.dataList= list
    }
    ...
    class ItemViewHolder(private var binding: ItemRecipesPreviewBinding) :
        ...
        fun bind(context: Context, item: SmoothieRecipesData, idList: ArrayList<Int?>) {
