...
class CategoryCoffeeActivity : AppCompatActivity() {
    ...
    private lateinit var adapter: CategoryCoffeeAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GlobalScope.launch(Dispatchers.IO){
            ...
            val tokenDb = TokenDatabase.getTokenDatabase(this@CategoryCoffeeActivity)
            ...
            service.get_Category(categoryId, is_Main, is_Official, token1)?.enqueue(object :
                ...
                override fun onResponse(
                    ...
                    adapter = CategoryCoffeeAdapter(this@CategoryCoffeeActivity, scraps)
                    layoutManager = GridLayoutManager(this@CategoryCoffeeActivity, 2)
