...
class TeaLoadingRVAdapter(private val context: ZipdabangRecipeTeaActivity, private var dataList: ArrayList<TeaRecipesData>, private var idList: ArrayList<Int?>) :
