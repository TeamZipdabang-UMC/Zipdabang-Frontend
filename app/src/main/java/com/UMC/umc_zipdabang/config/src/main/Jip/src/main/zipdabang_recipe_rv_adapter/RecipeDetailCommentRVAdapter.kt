...
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.GlideApp
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.Comment

class RecipeDetailCommentRVAdapter(private val commentsList: ArrayList<com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.Comment>): RecyclerView.Adapter<RecipeDetailCommentRVAdapter.CommentsViewHolder>() {
