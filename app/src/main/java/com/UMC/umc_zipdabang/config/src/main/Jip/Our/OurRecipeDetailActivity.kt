...
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.Comment
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.ZipdabangRecipeDetailCommentActivity
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.ZipdabangRecipeDetailReportActivity
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_rv_adapter.IngredientsRVAdapter
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_rv_adapter.RecipeDetailCommentRVAdapter
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_rv_adapter.RecipeOrderRVAdapter
                            ...
                            override fun onResponse(
                                ...
                                commentService.getThreeComments(tempToken, recipeId).enqueue(object: Callback<ThreeCommentsResponse> {
                                    override fun onResponse(
                                        ...
                                        viewBinding.rvOurRecipeComments.layoutManager = LinearLayoutManager(this@OurRecipeDetailActivity)
                                        viewBinding.rvOurRecipeComments.adapter = recipeDetailCommentLoadRVAdapter
                                    }
