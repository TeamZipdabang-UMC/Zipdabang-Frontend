...
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_activities_fragments.ZipdabangRecipeTeaActivity
import com.UMC.umc_zipdabang.config.src.main.Jip.src.main.zipdabang_recipe_comment.ZipdabangRecipeDetailTeaActivity
...
class TeaRecipesRVAdapter(private val context: ZipdabangRecipeTeaActivity, private var dataList: ArrayList<TeaRecipesData>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private fun update(list: ArrayList<TeaRecipesData>) {
        this.dataList= list
    }
