...
class CategoryHealthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GlobalScope.launch(Dispatchers.IO){
            ...
            val tokenDb = TokenDatabase.getTokenDatabase(this@CategoryHealthActivity)
            ...
            service.get_Category(categoryId, is_Main, is_Official, token1)?.enqueue(object :
                ...
                override fun onResponse(
                    ...
                    adapter = CategoryHealthAdapter(this@CategoryHealthActivity, scraps)
                    layoutManager = GridLayoutManager(this@CategoryHealthActivity, 2)
